<ul class="navigation clearfix">
	...
	<li class="dropdown {{ request()->routeIs('products*') ? 'current' : '' }}"><a href="{{ route('products') }}">Products <span class="fa fa-angle-down" style="margin-left:4px;font-size:14px;" aria-hidden="true"></span></a>
		<ul>
